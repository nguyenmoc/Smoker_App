...
import { Dimensions, Image, KeyboardAvoidingView, Linking, Modal, Platform, ScrollView, Text, TextInput, TouchableOpacity, View } from "react-native";
...
export default function Index({item, currentId, currentEntityAccountId, token, onAction}: RenderPostProps) {
    ...
    const AudioPlayer = ({ uri, postId }: { uri: string; postId: string }) => {
                            ...
                            <TouchableOpacity
                                onPress={() => {
                                    if (repostContent.trim()) {
                                        onAction({...data, repostContent: repostContent.trim()});
                                        setRepostModalVisible(false);
                                        setRepostContent('');
                                    }
                                }}
